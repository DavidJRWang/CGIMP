...
class App extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
		    ...
		    */
                    { field: "id", type: "string", label: "Pattern" },
                    { field: "factors", type: "concat", fs: "," },
                    { field: "modules", type: "count" }
                ]
            },
            dataPanelConfig: {
                nodeFields: [
		    ...
		    */
                    { field: "id", type: "string", label: "Pattern" },
                    { field: "modules", type: "count", label: "Total Modules" },
                    { field: "nDisplayed", label: "Displayed Modules" },
                    {
                        field: "factors",
                        type: "concat",
                        fs: ",",
		...
		*/
                ...
                includeFields: [
                    ...
                    { field: "factors", type: "array", sep: "," },
                    { field: "orth_type", type: "string" },
                    { field: "locus", type: "string" },
                    {
                        field: "maps_to",
                        type: "object",
    ...
    initDataStores = () => {
        ...
        axios
            ...
            .then(res => {
                ...
                this.setState({ nodeData: nodeData, nodeFields: fields });
    ...
    transformNodeData = nodeData => {
        ...
        this.setState({
            displayedNodeData: displayedNodeData,
    ...
    handleMapChange = selectedNodeModuleCount => {
        this.setState(
            { selectedNodeModuleCount: selectedNodeModuleCount },
            () => {
                this.forceUpdate();
            }
        );
        ...
        if (format === "json") {
            ...
            Object.keys(this.state.displayedData).forEach(key => {
                ...
                row.push(
                    ...
                    dat.loc.start,
                    dat.loc.end,
                    dat[this.state.dataDownloadConfig.nameField]
                );
    ...
    updateStateSettings = (name, value) => {
        if (name === "dimRows") {
            ...
            this.setState(
                { mapConfig: mapConfig, mapChangeFlag: Math.random() },
                this.forceUpdate()
            );
    ...
    render() {
        return (
            <div>
                    ...
                    controls={
                        Object.keys(this.state.displayedData).length ? (
                            <MapControls
                                ...
                                onNewSearchAction={
                                    this.handleNewElasticsearchPromise
                                }
                        ...
                        Object.keys(this.state.displayedData).length ? (
                            this.state.selectedNode ? (
                                <DataPanel
                                    ...
                                    displayedData={this.state.displayedData}
                                    nDisplayed={
                                        this.state.selectedNodeModuleCount
                                    }
                                    nodeData={
                                        this.state.nodeData[
                                            this.state.selectedNode
                ...
                />
                <LoadAlertDialog open={!this.state.dataIsLoaded} />
                <SettingsDialog
                    onSettingsClick={this.handleSettingsClick}
