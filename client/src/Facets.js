...
const initScrollUrl =
    browser.elasticAddr + "/browser/modules/_search?scroll=1m";
...
class FacetedSearch extends Component {
    constructor(props) {
        ...
        this.getFacetsFromElasticsearch = this.getFacetsFromElasticsearch.bind(
            this
        );
    }
            ...
            client.search(
                ...
                (err, res) => {
                    ...
                    if (i === numericFields.length) {
                        this.setState(
                            { numericRanges: ranges, facetsSet: true },
                            () => {
                            ...
                            if (facet.dataType === "text") {
                                ...
                                return (
                                    <RangeInput
                                        ...
                                        title={facet.title}
                                        range={{
                                            start: this.state.numericRanges[
                                                facet.title
                                            ].min,
                                            end: this.state.numericRanges[
                                                facet.title
                                            ].max
                                        }}
                                    />
